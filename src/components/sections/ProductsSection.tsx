      ...
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-col items-center">
          <img 
            ...
            className="w-full h-auto object-contain max-w-3xl mb-10 hover:scale-105 transition-transform duration-500"
          />
        ...
        {/* Efeito de ondas melhorado */}
        <div className="relative h-32 mt-10 overflow-hidden">
          <div className="absolute w-full h-full">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" className="w-full h-full text-water-300 opacity-50">
          ...
          <div className="absolute w-full h-full -translate-x-1/4 animate-[moveWave_10s_ease-in-out_infinite]">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" className="w-full h-full text-water-400 opacity-40">
          ...
          <div className="absolute w-full h-full translate-x-1/3 animate-[moveWave_8s_ease-in-out_infinite_reverse]">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" className="w-full h-full text-water-500 opacity-30">
