      ...
      <div className="container mx-auto">
        ...
        <div className="relative h-40 mt-10 overflow-hidden">
          <div className="absolute w-full h-full">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" className="w-full h-full text-water-300 opacity-60 animate-[wave_15s_ease-in-out_infinite]">
          ...
          <div className="absolute w-full h-full -translate-x-1/4 animate-[wave_12s_ease-in-out_infinite_reverse]">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" className="w-full h-full text-water-400 opacity-50">
          ...
          <div className="absolute w-full h-full translate-x-1/3 animate-[wave_10s_ease-in-out_infinite]">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" className="w-full h-full text-water-500 opacity-40">
